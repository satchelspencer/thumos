	...
	return function(config){
		...
		var api = {
			...
			get : function(inp, callback){
				...
				else ajax.req('get', api.path+'/i/'+inp.ids.join(','), function(e, models){
			...
			update : function(models, callback){
				api.valid(models, function(e, update){
					if(e) callback(e);
					else ajax.req('put', api.path, update, function(e, updated){
			...
			del : function(inp, callback){
				var inp = parse(inp);
				if(inp.error) callback(inp.error);
				else ajax.req('delete', api.path+'/i/'+inp.ids.join(','), function(e, removedIds){
			...
			add : function(models, callback){
				api.valid(models, function(e, toAdd){
					if(e) callback(e);
					else ajax.req('post', api.path, toAdd, function(e, newModels){
						if(!e){
			...
			find : function(props, callback){
				ajax.req('post', api.path+'/find', props, function(e, models){
					if(!e) api.trigger('change', api.getChanged(models));
					callback(e, models);
				});
			},
			...
			query : function(query, params, callback){
				ajax.req('post', api.path+'/q/'+query, params, function(e, models){
					if(!e) api.trigger('change', api.getChanged(models));
					callback(e, models);
				});
			},
